...
# Age this until Day 222
executeAging(Get-Date $startDate.AddDays(221) -Format 'yyyy-MM-dd')
write-output "`n Regression - Say - Day 222 - RCAN.xlsx"
$dataFile = Import-Excel ("D:\RegressionTests_New\Test Data - R12 - UNIT - Say Regression - 2019 08 02-template-for-autogenerated-data\Regression - Say - Day 222 - RCAN.xlsx")
InvokeWebRequest($dataFile)
Write-Output "`n Finished Day 222"

# Age this until Day 244
executeAging(Get-Date $startDate.AddDays(243) -Format 'yyyy-MM-dd')